...
begin
	zplot(z -> f(z),[-2π,2π],[-2π,2π], 10)
	title!("f(z)=sin(z)")
end

# ╔═╡ 3bc198c9-1535-4925-a364-d1dd570b6167
md"""**Nota:** Para mejorar la calidad de la gráfica cambie "10" por un valor más grande. Para que se vea como la siguiente imagen."""

# ╔═╡ 1c562b7d-6cc6-49a9-ae89-acf641e22645
let
	url = "https://github.com/labmatecc/labmatecc.github.io/blob/main/Im%C3%A1genes/Plot1.jpeg?raw=true"
	fname = download(url)
	imag = load(fname)
end
...
begin
	zplot(z -> 1/sqrt(z),[-2π,2π],[-2π,2π], 10)
	title!("f(z)=1/sqrt(z)")
end

# ╔═╡ b9e66ac0-2e75-4670-8020-b9ce48f6e736
md"""**Nota:** Para mejorar la calidad de la gráfica cambie "10" por un valor más grande. Para que se vea como la siguiente imagen."""

# ╔═╡ df1555e3-da2e-4588-ac90-997c9bd97bb7
let
	url = "https://github.com/labmatecc/labmatecc.github.io/blob/main/Im%C3%A1genes/Plot2.jpeg?raw=true"
	fname = download(url)
	imag = load(fname)
end
