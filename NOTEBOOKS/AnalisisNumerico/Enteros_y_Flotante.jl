...
begin
	...
	print("x=",xp," es un numéro de máquina pero 'y' genera desbordamiento.\n")
end
...
**PROBLEMA (Stoer) 6** Ensaye calcular las funciones $$f(x)=\sqrt{x^2+1}-1 \quad g(x)=\frac{x^2}{\sqrt{x^2+1}+1}$$
