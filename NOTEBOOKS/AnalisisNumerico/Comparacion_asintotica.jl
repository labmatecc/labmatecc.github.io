...
$\sin(x)=x-\frac{x^3}{6}+\mathcal{O}(x^5), \quad \text{ cuando }x\to 0.$ Se puede pensar que se toman sucesiones $x_n\to 0$. Para verificar esta afirmación, se puede graficar la función $\sin(x)$ junto con la aproximación $x - \frac{x^3}{6}$. Además, incluir la función $\frac{x^5}{5!}$ en la gráfica permite visualizar la corrección adicional y apreciar cómo la diferencia entre $\sin(x)$ y la aproximación se reduce conforme $x$ se acerca a cero. """
...
manifest_format = "2.0"
project_hash = "1e918640cff7f1c76ebe50da3429aa90ceffc950"
