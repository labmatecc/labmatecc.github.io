...
# ╔═╡ f83c7795-f18b-4b95-8944-ff934b291df9
md"""Este cuaderno está en construcción y puede ser modificado en el futuro para mejorar su contenido. En caso de comentarios o sugerencias, por favor escribir a **labmatecc_bog@unal.edu.co**

Tu participación es fundamental para hacer de este curso una experiencia aún mejor."""

# ╔═╡ d37822d7-480c-4f7f-ab83-806655326573
...
El ajuste de curvas o ajuste de datos consiste en buscar una relación entre ellos. Es decir, si tenemos datos correspondientes a dos variables, la idea es encontrar una relación que describa de manera precisa el comportamiento de dichos datos.
...
# ╔═╡ 2152d563-249c-432f-9869-d83e10f7de50
...
$V(t) \approx a+bt$
y queremos estimar los parámetros $a$ y $b$.
...
Asumamos que el modelo cúbico tiene la siguiente forma:

$V(t) \approx a+bt+ct^2+dt^3,$
y queremos estimar los parámetros $a,b,c$ y $d$.
...
md"""De esto se tiene que la ecuación cúbica que se ajusta a los datos dados es 
...
$V(t) \approx 2.872\frac{1}{1+e^{0.519t+ 25.399}}+7.279\frac{1}{1+e^{-0.195t+ 4.680}}.$
...
Para ilustrar el procedimiento, ajustaremos los datos a un modelo de ecuaciones diferenciales, el Modelo de von Bertalanffy. Este modelo se utiliza para mostrar el crecimiento de tumores en el cuerpo, donde el crecimiento del tumor se desacelera a medida que se hace más grande. El modelo es dado como

$V'=aV^{\frac{2}{3}}-bV,$
donde $V$ es el tamaño del tumor en el tiempo $t$, el parámetro $a$ es la velocidad máxima de crecimiento, y $b$ es la tasa de muerte celular o retroceso del tumor.
...
Después de calcular el valor del parámetro óptimo, podemos mostrar el ajuste final de nuestro modelo. Como antes, podemos visualizar el ajuste comparándolo con los datos. Para esto tenemos el siguiente gráfico.
"""
...
este modelo describe el crecimiento de poblaciones bajo ciertas condiciones. $V$ representa la población en el instante $t$, donde $V'$ representa la tasa de cambio de la población con respecto al tiempo. El parámetro $a$ es la tasa de crecimiento intrínseca de la población y $b$ es la capacidad de carga del entorno, es decir, el máximo tamaño de la población que el entorno puede soportar de manera sostenible. Así, la ecuación describe cómo la tasa de crecimiento de una población cambia a medida que la población se acerca a su capacidad máxima de carga en un entorno dado.
...
# ╔═╡ 0d60525b-4109-4ff9-857b-b2dd3383413b
begin
...
md"""Por ejemplo, el desajuste de usar $a=1$ y $b=1$ en el modelo es dada como:"""
...
md"""y, optimizamos su valor, es decir, """
...
md"""Obteniendo así que los valores óptimos para $a$ y $b$ son $0.297$ y $7.012$, respectivamente. Por lo tanto, la ecuación esta dado por
...
entre otros. O intetente modelos de ecuaciones diferenciales.
"""

# ╔═╡ 0c176410-dcb5-42d0-80b0-904e9b5645ab
md"""
# Referencias
[1] Driscoll, T. A., & Braun, R. J. (n.d.). Revisión del libro de texto *Fundamentals of Numerical Computation*. Adaptado a Julia. Recuperado de https://tobydriscoll.net/fnc-julia/home.html
