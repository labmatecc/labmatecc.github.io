...
PlutoUI.TableOfContents(title="Oscilador armónico (cálculo simbólico)", aside=true)
...
begin
	url = "https://github.com/labmatecc/labmatecc.github.io/blob/main/Im%C3%A1genes/Harmonic2.png?raw=true"
...
begin
	url₂ = "https://github.com/labmatecc/labmatecc.github.io/blob/main/Im%C3%A1genes/Harmonic3.png?raw=true"
	fname₂ = download(url₂) #bajamos la imagen a la máquina local
	imag₂ = load(fname₂) #declaramos la variable "imag"
end
...
begin
	url₃ = "https://github.com/labmatecc/labmatecc.github.io/blob/main/Im%C3%A1genes/Harmonic4.png?raw=true"
	fname₃ = download(url₃) #bajamos la imagen a la máquina local
	imag₃ = load(fname₃) #declaramos la variable "imag"
end
...
begin
	url₄ = "https://github.com/labmatecc/labmatecc.github.io/blob/main/Im%C3%A1genes/Harmonic1.png?raw=true"
	fname₄ = download(url₄) #bajamos la imagen a la máquina local
	imag₄ = load(fname₄) #declaramos la variable "imag"
end
