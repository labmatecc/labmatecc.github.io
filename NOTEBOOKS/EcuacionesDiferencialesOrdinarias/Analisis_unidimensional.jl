...
# ╔═╡ e35e422f-a2f7-4b30-adec-8aaeda1c4c56
begin
	using Plots
	using LaTeXStrings
...
# ╔═╡ 039e3130-9b07-11ef-2228-497ad90a1c3e
md"""
# Análisis Cualitativo Unidimensional

Cuando no podemos resolver las ecuaciones diferenciales de forma analítica siempre está la opción de observar cómo es su comportamiento gráfico a lo largo del tiempo, estos comportamientos permiten dar estimaciones y con ello dar respuestas a preguntas referentes al futuro descrito por la ecuación diferencial.
"""

# ╔═╡ 3201004b-0ab8-4974-a12a-0bd64860974a
md""" 
## Normalizar una ecuación diferencial

Cualquier ecuación diferencial se escribe de la forma 

$$f\left(x,y,\frac{dy}{dx}\right)=0$$

Es decir que escribimos la ecuación en términos de $x$, $y$ y $\frac{dy}{dx}$

Muchas veces encontramos ecuaciones diferenciales descritas de forma explicita a su derivada

$$\frac{dy}{dx}=cos(x)+y$$

Pero también tendremos la forma de la ecuación como 

$$\frac{\frac{dy}{dx}}{cos(x)+y}=1$$

O más aún en su forma diferencial

$$\frac{dy}{cos(x)+y}-dx=0$$

Cada una de estas ecuaciones es equivalente en el dominio adecuado, es ahí donde definimos una **ecuación diferencial normal**, que es la de la forma 

$$\frac{dy}{dx}=f(x,y)$$

Es decir donde la **derivada está despejada**.


"""

# ╔═╡ 35ebc4d5-f904-4810-9cfa-62ddb2a33827
md"""
## Campo de pendientes

Para una ecuación diferencial normal $\frac{dy}{dx}=f(x,y)$ se tiene que $f$ es un *campo escalar*, es decir, a cada punto del espacio se le puede asignar una pendiente, esa pendiente la usamos para indicar en qué dirección se dirige la función $y(x)$, puesto que la mejor aproximación lineal de la función siempre es la recta descrita por la derivada, trasladada al punto donde pasa, es decir, para el punto $(a,b)$ la mejor aproximación de la función es $y-b\approx\left(\frac{dy}{dx}(a) \right) (x-a)$.

Use los deslizadores para ver cómo cambia la pendiente según el punto de evaluación:
"""

# ╔═╡ ce0a7073-4989-4136-bc66-41adabff05db
md""" Valor en el eje $x$: """

# ╔═╡ 0b123a4a-0887-4790-9243-5ed423e35a7e
@bind xi Slider(-4.5:0.1:4.5, show_value=true, default=0)  # Rango de -10 a 10 con pasos de 0.1

# ╔═╡ 3acf9105-a06f-47c5-88b0-f06b2ea67645
md""" Valor en el eje $y$: """

# ╔═╡ 4adabd89-8baf-4fea-a19a-c0b171db8e6d
@bind yi Slider(-4.5:0.1:4.5, show_value=true, default=0)  # Rango de -10 a 10 con pasos de 0.1

# ╔═╡ 5ad92c4a-11d5-441a-bc30-f4e5c9d8a21c
begin
    # Definimos la función f(x, y) que describe el campo de pendientes
    f(x, y) = -x + y

    # Definimos un único punto donde graficar el campo de pendientes

    # Calculamos la pendiente en el punto
    slope = f(xi, yi)
    norm = sqrt(1 + slope^2)
    u₁ = 1 / norm
    v₁ = slope / norm

    # Graficamos el campo de pendientes solo en el punto (xi, yi)
    quiver([xi], [yi], quiver=([u₁], [v₁]), aspect_ratio=:equal, xlims=(-5, 5), ylims=(-5, 5), title="Campo de Pendientes en un Punto", xlabel="x", ylabel="y")
end

# ╔═╡ 75ddd6a0-7bc4-4ce3-aad9-540075a8ba79
md""" Si tomamos en cuenta todas las pendientes podremos observar la trayectoria de la función, esto se verifica graficando la función que pase por un punto específico, es decir que tenga definidas sus condiciones iniciales"""

# ╔═╡ 98a51a41-4aa0-4069-b55e-894b148ad81f
md"""
## Ecuaciones diferenciales autónomas

El análisis cualitativo se centra en estudiar las propiedades generales de las soluciones de una EDO, como su estabilidad y comportamiento a largo plazo, sin resolverla explícitamente, para ello, analizar la variable dependiente al tiempo únicamente facilita el trabajo haciendo que el campo de pendientes sea constante respecto a una variable. Para ello definimos lo que es una ecuación diferencial autónoma, Consideremos una EDO autónoma de primer orden como:
...
-  $t$ es la variable independiente (generalmente el tiempo).
-  $f(x)$ es una función continua de $x$.

### Importancia del Análisis Cualitativo

- **Simplicidad**: Evita cálculos complejos de soluciones exactas.
- **Intuición**: Proporciona una comprensión visual y conceptual del sistema.
- **Predicción**: Ayuda a predecir el comportamiento a largo plazo de las soluciones.

### Ecuaciones Autónomas $f(x)$

En el caso unidimensional, el sistema se simplifica a una sola ecuación:

$$\frac{dx}{dt} = f(x)$$

El plano fase se reduce a una línea (el eje $x$), y el campo vectorial indica la dirección del cambio de $x$.
...
Donde:
 ...
 $r$ es la tasa de crecimiento intrínseca y $K$ es la capacidad de carga.

Esta ecuación modela el crecimiento poblacional con límite superior $K$.

## Puntos de Equilibrio

Un punto de equilibrio es un valor $x^*$ donde el sistema no cambia con el tiempo, es decir:

$$f(x^*) = 0$$

"""

# ╔═╡ 81db3d79-7425-428e-8f0e-096cec9c4716
md"""
# Practica un poco
"""

# ╔═╡ 632bf9ac-ad84-43f1-b1be-679d2f4ee327
md"""
Define el valor de $r$:
"""

# ╔═╡ caa3e6c0-e3b9-4437-bfa6-3d518f376f0b
@bind r Slider(0:0.1:5.0, show_value=true, default=0)  # Rango de -10 a 10 con pasos de 0.1

# ╔═╡ 856c07a5-c8a3-494b-b3ad-0da3b17b6a7e
md"""
Define el valor de $K$:
"""

# ╔═╡ 1e38f019-18c2-47be-8e7f-7403f247796f
@bind K Slider(1:0.1:5.0, show_value=true, default=0)  # Rango de -10 a 10 con pasos de 0.1

# ╔═╡ 43f52951-c4a1-492b-8571-e23786127540
md""" Condición inicial en el tiempo: """

# ╔═╡ be3fe1f6-00ba-46a7-8071-215a64bfc753
@bind t₂ Slider(-4.5:0.1:4.5, show_value=true, default=0)  # Rango de -10 a 10 con pasos de 0.1

# ╔═╡ 3452e5ff-3c1e-4473-956f-a821f5b3fe74
md""" Condición inicial de x: """

# ╔═╡ 0137afe3-a86f-4ade-9c22-4c220afcdad8
@bind x₂ Slider(-4.5:0.1:4.5, show_value=true, default=0)  # Rango de -10 a 10 con pasos de 0.1

# ╔═╡ e1eb59aa-34d6-4c70-926b-bff29da24e8f
md"""
### Importancia de los Puntos de Equilibrio

- **Estados Estacionarios**: Representan condiciones donde el sistema permanece constante.
- **Análisis de Estabilidad**: Determinan si pequeñas perturbaciones crecerán o decaerán con el tiempo.
- **Comportamiento a Largo Plazo**: Ayudan a predecir la evolución futura del sistema.

### Estabilidad de los Puntos de Equilibrio

- **Estable**: Si las soluciones cercanas a $x^*$ tienden hacia $x^*$ con el tiempo.
- **Inestable**: Si las soluciones cercanas a $x^*$ se alejan de $x^*$ con el tiempo.
- **Semiestable**: Si las soluciones se acercan a $x^*$ en una dirección y se alejan en otra.

#### Criterio de Estabilidad

Analizando la derivada $f'(x^*)$:

- Si $f'(x^*) < 0$, el punto es estable.
- Si $f'(x^*) > 0$, el punto es inestable.
- Si $f'(x^*) = 0$, el criterio es inconcluso y se requiere un análisis adicional.
...
- **Puntos de equilibrio**: $x^* = 0$ y $x^* = \frac{a}{b}$.
- **Derivadas**:
  -  (inestable) $f'(0) = a > 0$.
  -  (estable) $f'\left(\frac{a}{b}\right) = -a < 0$.
"""

# ╔═╡ 716a52dc-2c7d-4020-a46c-b811b6e97059
md""" Note que para $f(t)=0$ se tiene que las soluciones en tiempo futuro buscan alejarse, mientras que para $f(t)=1$ las soluciones buscan converger a la recta.""" 

# ╔═╡ f0cc4501-3aef-4df5-a9a3-95a0dac05fe9
md"""
#### Pasos para Graficar:

1. **Calcular $f(x)$** en varios puntos.
2. **Dibujar flechas** indicando la dirección (positiva o negativa) de $\frac{dx}{dt}$.
3. **Identificar puntos de equilibrio** donde $f(x) = 0$.

#### Ejemplo

Para $\frac{dx}{dt} = x (1 - x)$:

- **Puntos de equilibrio**: $x^* = 0$, $x^* = 1$.
- **Direcciones**:
  - Si $x < 0$, $f(x) < 0$ (flechas hacia la izquierda).
  - Si $0 < x < 1$, $f(x) > 0$ (flechas hacia la derecha).
  - Si $x > 1$, $f(x) < 0$ (flechas hacia la izquierda).

### Campo de pendientes

Resumen visualmente el comportamiento del sistema.

- **Ejes**: Solo el eje $x$.
- **Flechas**: Indican la dirección del cambio de $x$.
- **Puntos de Equilibrio**: Marcados y clasificados según su estabilidad.


"""

# ╔═╡ f5ef5b71-cb27-4e09-b004-2475dea719bd
md""" # Aplicaciones"""

# ╔═╡ b582bd66-5e94-40a3-b597-8f6099f1887c
md"""### Ejemplo 1: Crecimiento Logístico en Ecología

La ecuación diferencial logística se utiliza para modelar el crecimiento poblacional de especies en un hábitat con recursos limitados, como una reserva natural.

**Ecuación:**  
$$\frac{dy}{dt}=ry\left(1-\frac{y}{K}\right)$$

- **Parámetros**:
  -  $r=0.5$: tasa de crecimiento de la población de ciervos.
  -  $K=100$: capacidad de carga máxima de la reserva para los ciervos.

**Aplicación:**  
En una reserva que puede sostener hasta $100$ ciervos ($K=100$), la población inicial es de $10$. Determine si esta población alcanzará eventualmente el límite y analice el tiempo que tomaría acercarse a este equilibrio.

**Análisis de Estabilidad:**  
- Puntos críticos: $y=0$ y $y=K$.
  -  $y=0$: inestable, pues una perturbación positiva hará crecer la población.
  -  $y=K$: estable, ya que la población se estabiliza cuando se alcanza la capacidad de carga.

"""

# ╔═╡ c3b25bae-a330-40a7-a3fc-d7f1133ee494
ejemplo₁(t,y) = 0.5*y*(1-(y/100)) 

# ╔═╡ 866ed016-ecea-4464-a12f-e2191702aebf
md""" ### Ejemplo 2: Crecimiento Exponencial en Interés Compuesto Continuo

Esta ecuación describe cómo se acumulan los intereses de una inversión que crece exponencialmente, como un depósito en un banco con interés compuesto continuo.

**Ecuación:**  
$$\frac{dy}{dt}=ky$$

- **Parámetros**:
  -  $k=0.05$: tasa de interés anual compuesta continuamente.

**Aplicación:**  
Una inversión inicial de $1000$ dólares se coloca en una cuenta con interés compuesto continuo. Calcule el valor de la inversión después de $10$ años y observe su crecimiento.

**Análisis de Estabilidad:**  
- Punto crítico: $y=0$.
-  $y=0$: inestable, cualquier cantidad inicial positiva crecerá exponencialmente.
 """

# ╔═╡ 96d82ed0-7363-4600-9996-147f59014157
ejemplo₂(t,y) = 0.05*y

# ╔═╡ 7cf7d89e-b26d-4286-b2a7-06d4395942ad
md""" ### Ejemplo 3: Enfriamiento de un Cadáver en Medicina Forense

La Ley de Enfriamiento de Newton se aplica en medicina forense para determinar el tiempo de muerte aproximado de un cadáver encontrado en un entorno específico.

**Ecuación:**  
$$\frac{dT}{dt}=-k(T-T_{\text{amb}})$$

- **Parámetros**:
  -  $k=0.07$: constante de enfriamiento del cuerpo.
  -  $T_{\text{amb}}=20$: temperatura ambiental en grados Celsius.

**Aplicación:**  
Un cadáver se encuentra a una temperatura de $30^\circ$C en un ambiente de $20^\circ$C. Si la temperatura del cuerpo era de $37^\circ$C en el momento de la muerte, determine cuánto tiempo ha pasado desde el fallecimiento.

**Análisis de Estabilidad:**  
- Punto crítico: $T=T_{\text{amb}}$.
  -  $T=T_{\text{amb}}$: estable, ya que la temperatura del cuerpo tenderá a la temperatura ambiental con el tiempo."""

# ╔═╡ d2f18338-2cbf-41ba-aadf-0fee4ad70f2b
ejemplo₃(t,T) = -0.07*(T-20)

# ╔═╡ eeb1d192-57d6-45e0-a6e0-1dd10c755f01
md"""
**Referencias:**

- Strogatz, S. H. *Nonlinear Dynamics and Chaos*. Westview Press, 2014.
- Boyce, W. E., & DiPrima, R. C. *Ecuaciones Diferenciales y Problemas con Valores en la Frontera*. Wiley, 2010.

"""

# ╔═╡ ab50dcec-3e2b-4faa-9aef-42940d38b835
# Definir el método de Runge-Kutta de cuarto orden en un intervalo [a, b] con (t_0, x_0) en medio
function runge_kutta(f, a::Float64, b::Float64, t0::Float64, x0::Float64, n::Int)
    # Tamaño del paso para la integración hacia adelante
    h_forward = (b - t0) / n

    # Tamaño del paso para la integración hacia atrás
    h_backward = (t0 - a) / n

    # Inicializar los valores para el intervalo hacia adelante
    t_forward = t0
    x_forward = x0
    t_forward_values = Float64[t_forward]
    x_forward_values = Float64[x_forward]
    
    # Integrar hacia adelante desde t0 hasta b
    for i in 1:n
        k1 = h_forward * f(t_forward, x_forward)
        k2 = h_forward * f(t_forward + h_forward/2, x_forward + k1/2)
        k3 = h_forward * f(t_forward + h_forward/2, x_forward + k2/2)
        k4 = h_forward * f(t_forward + h_forward, x_forward + k3)
        
        # Actualizar x_forward con la combinación ponderada de los incrementos
        x_forward += (k1 + 2*k2 + 2*k3 + k4) / 6
        t_forward += h_forward
        
        # Almacenar los valores en los vectores
        push!(t_forward_values, t_forward)
        push!(x_forward_values, x_forward)
    end
    
    # Inicializar los valores para el intervalo hacia atrás
    t_backward = t0
    x_backward = x0
    t_backward_values = Float64[t_backward]
    x_backward_values = Float64[x_backward]
    
    # Integrar hacia atrás desde t0 hasta a
    for i in 1:n
        k1 = -h_backward * f(t_backward, x_backward)
        k2 = -h_backward * f(t_backward - h_backward/2, x_backward + k1/2)
        k3 = -h_backward * f(t_backward - h_backward/2, x_backward + k2/2)
        k4 = -h_backward * f(t_backward - h_backward, x_backward + k3)
        
        # Actualizar x_backward con la combinación ponderada de los incrementos
        x_backward += (k1 + 2*k2 + 2*k3 + k4) / 6
        t_backward -= h_backward
        
        # Almacenar los valores en los vectores
        push!(t_backward_values, t_backward)
        push!(x_backward_values, x_backward)
    end
    
    # Invertir los resultados hacia atrás para tener una secuencia ordenada en [a, b]
    reverse!(t_backward_values)
    reverse!(x_backward_values)
    
    # Combinar los resultados de ambas integraciones
    t_values = vcat(t_backward_values, t_forward_values[2:end])
    x_values = vcat(x_backward_values, x_forward_values[2:end])
    
    return t_values, x_values
end


# ╔═╡ 4c36d1ec-c46c-4b95-a8db-e3c67cca49e6
function graficar_plano_fase(x_inf, y_inf, x_sup, y_sup, f, nombre_de_la_funcion_f, x_0, y_0)
	graficar_plano_fase(x_inf, y_inf, x_sup, y_sup, f)
	solucion_x, solucion_y = runge_kutta(f, x_inf, x_sup, x_0, y_0, 100)
	# Graficamos la solución
    plot!(solucion_x, solucion_y, xlims=(x_inf, x_sup),  ylims=(y_inf, y_sup),label=nombre_de_la_funcion_f, width=3)
end

# ╔═╡ 6fb96180-a256-41fb-bfbd-905a5db1efec
function graficar_plano_fase(x_inf, y_inf, x_sup, y_sup, f)
	# Definimos el rango del campo de pendientes
	xstep = (x_sup-x_inf)/20
	ystep = (y_sup-y_inf)/20
    xrange = x_inf:xstep:x_sup
    yrange = y_inf:ystep:y_sup

    # Generamos el campo de pendientes
    x, y = [], []
    u, v = [], []

    for xi in xrange, yi in yrange
        push!(x, xi)
        push!(y, yi)
        slope = f(xi, yi)
        norm = sqrt(1 + slope^2)
        push!(u, xstep*(1 / norm))
        push!(v, ystep*(slope / norm))
    end

    # Graficamos el campo de pendientes
    quiver(x, y, quiver=(u, v), ratio=1, xlims=(x_inf, x_sup), ylims=(y_inf, y_sup), title="Campo de Pendientes", xlabel="x", ylabel="y")
end

# ╔═╡ 86ddf9bf-6587-4534-99b4-3621f3e75fcc
begin
graficar_plano_fase(-5.0, -5.0, 5.0, 5.0, f)
end

# ╔═╡ 8d95f560-779a-416d-84da-8ed516c962fe
begin
	f₂(t,x)=r*x*(1-(x/K))
	graficar_plano_fase(-5.0, -5.0, 5.0, 5.0, f₂,"x(t)", t₂, x₂)
end

# ╔═╡ c67f49ab-290b-4d8b-af2d-14ff73a1613c
@gif for i in -125:125
		t₃ = 0.0
		x₃ = 0.04*i
		f₃(t,x) = x*(1-x)
		graficar_plano_fase(-5.0, -5.0, 5.0, 5.0, f₃,"x(t)", t₃, x₃)
		scatter!([t₃], [x₃], marker=:circle, label="Condición inicial", color=:red ,xlabel="Eje t", ylabel="Eje x", xlims=(-5.0, 5.0), ylims=(-5.0, 5.0), legend=:topleft, title="Comportamiento de las soluciones de\n dy/dx = x(1-x)")
	end

# ╔═╡ 6f5afc87-4c5a-41e4-b2da-b37b76206bbd
graficar_plano_fase(-100.0, -100.0, 150.0, 150.0, ejemplo₁, "Población de siervos", 0.0, 10.0)

# ╔═╡ de409a63-be28-431a-b5ea-b5009832a8ad
graficar_plano_fase(-1000.0, -1000.0, 1500.0, 1500.0, ejemplo₂, "Interés", 0.0, 1000.0)

# ╔═╡ cb4a904a-c9f9-430e-84fe-09737359bf6a
graficar_plano_fase(0.0, 0.0, 50.0, 50.0, ejemplo₃, "Temperatura", 0.0, 37.0)

# ╔═╡ 4d4a2ff9-1c4f-446f-81b3-4a7e28821a79
PlutoUI.TableOfContents(title="Análisis Cualitativo Unidimensional", aside=true)
...
manifest_format = "2.0"
project_hash = "2bb4f52bf2ba46c75ddc125848a9e664d99ebd76"
