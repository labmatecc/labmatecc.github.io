...
PlutoUI.TableOfContents(title="Introducción a la optimización", aside=true)
...
# ╔═╡ 9f5ff4f5-8470-4e6a-8607-1356469f8518
md"""# Optimización en una variable sin restricciones"""

# ╔═╡ 60646b5d-21e1-4a2c-8cc1-c0a038e95a60
function fs(x)
    return -exp(-(x - 1/10)^2)
end

# ╔═╡ b801a244-720a-47fc-9df2-7733d5226e5f
md"""En una dimensión podemos hacer una exploración inicial con una gráfica para tener una idea del tipo de función  y de la existencia de minimos."""

# ╔═╡ d0769ff8-336b-4158-8085-3b93d7904d39
begin
	a, b = -3, 3
	x = a:((b - a)/1000):b
	y = fs.(x)
	plot(x, y, color=:red, linewidth=4, label="Función", legend=:topright)
end

# ╔═╡ bb1202e6-8bff-4b8f-a4d7-56b99ab8ab6e
md"""En la region usada esta funcion parece cuasiconvexa (lo cual puede ser verificado fácilmente). Podemos usar el optimizador escalar de optimize para encontrar el valor mínimo asi como el punto de mínimo."""

# ╔═╡ 17926032-3286-40d1-99fa-f48bf8b48093
let
	result = optimize(fs, -3, 3)

	println("Éxito: ", result.converged)
	println("El punto óptimo es: ", result.minimizer)
	println("El valor óptimo es: ", result.minimum)
	println("El número de iteraciones es: ", result.iterations)
end

# ╔═╡ 764f18b3-3cb5-403b-a11e-6f26d1991178
