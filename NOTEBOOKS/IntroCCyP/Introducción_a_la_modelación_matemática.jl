...
3. Proponer un método numérico  (asumiendo aritmética exacta) que permita usar la relación  obtenida para $q$  a partir de $p$ (o incluso $d$) ya sea en un número finito de pasos o como limite de un método iterativo.
...
En este cuaderno ilustraremos el proceso de modelación matemática  a través de un ejemplo sencillo."""
...
A lo largo de esta presentación, haremos énfasis en los errores que se cometen en el proceso.
"""
